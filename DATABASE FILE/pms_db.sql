...
(92, 'Microlax'),
(93, 'Bioplacenton'),
(94, 'Erlamycetin (tetes telinga)'),
(95, 'Erlamycetin Plus (tetes mata)'),
(96, 'Erlamycetin (salep mata)'),
(97, 'Allertol'),
(98, 'Bedak salicyl'),
(99, 'Combatrin tablet'),
(100, 'Acyclovir (salep)'),
(101, 'Synalten'),
(102, 'Ketoconazole (salep)'),
(103, 'Faxiden gel'),
(104, 'Test pack'),
(105, 'GOM'),
(106, 'Betadine'),
...
--
ALTER TABLE `create_generic_name`
  MODIFY `generic_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
