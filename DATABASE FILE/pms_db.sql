...
(2, 'owner', '202cb962ac59075b964b07152d234b70');
...
(1, 'Antiviral'),
(2, 'Analgesik/antiinflamasi'),
(3, 'Mukolitik'),
(4, 'Antiplatelet/analgesik dosis rendah'),
(5, 'Hemostatik'),
(6, 'Antihiperurisemia'),
(7, 'Obat flu/batuk kombinasi'),
(8, 'Vitamin/suplemen'),
(9, 'Antibiotik'),
(10, 'Obat jantung'),
(11, 'Antihipertensi'),
...
(13, 'Diuretik'),
(14, 'Obat lambung'),
(15, 'Antialergi/kortikosteroid'),
(16, 'Antibiotik/antiprotozoa'),
(17, 'Bronkodilator/asma'),
(18, 'Obat vertigo'),
(19, 'Obat jantung/antiangina'),
(20, 'Mukolitik/ekspektoran'),
(21, 'Antihistamin'),
(22, 'Analgesik + vitamin B'),
(23, 'Antiemetik/prokinetik');
...
CREATE TABLE `create_medicine_name` (
  ...
  `medicine_presentation_name` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
(1, 'Acyclovir', 1, 'Antiviral', NULL, 'Acyclovir 400 mg'),
(2, 'Etafen', 2, 'Analgesik/antiinflamasi', NULL, 'Ibuprofen 400 mg'),
(3, 'Acetylsisteine', 3, 'Mukolitik', NULL, 'Acetylsisteine 200 mg'),
(4, 'Aspilet', 4, 'Antiplatelet/analgesik dosis rendah', NULL, 'Acetylsalicylic acid 80 mg'),
(5, 'Adrome', 5, 'Hemostatik', NULL, 'Carbazochrome sodium sulfonate'),
(6, 'Omeric', 6, 'Antihiperurisemia', NULL, 'Allopurinol 100 mg'),
(7, 'Calortusin', 7, 'Obat flu/batuk kombinasi', NULL, 'Paracetamol 500 mg, Dextromethorphan HBr 15 mg, Phenylpropanolamine HCl 15 mg, Chlorpheniramine maleate 2 mg'),
(8, 'Caviplex', 8, 'Vitamin/suplemen', NULL, 'Vit A, Vit D, Vit C, Nikotinamid, Ca Pantotenat, Ca Laktat, Ca Gliserofosfat, Asam Glutamat'),
(9, 'Lostacef', 9, 'Antibiotik', NULL, 'Cefadroxil 500 mg'),
(10, 'Dionicol', 9, 'Antibiotik', NULL, 'Thiamphenicol 500 mg'),
(11, 'Fargoxin', 10, 'Obat jantung', NULL, 'Digoxin 0,25 mg'),
(12, 'Farmoten', 11, 'Antihipertensi', NULL, 'Captopril 25 mg'),
(13, 'Etafemin', 2, 'Analgesik/antiinflamasi', NULL, 'Asam mefenamat 500 mg'),
(14, 'Glikos', 12, 'Antidiabetes', NULL, 'Metformin 500 mg'),
(15, 'Farsetic', 13, 'Diuretik', NULL, 'Furosemide 40 mg'),
(16, 'Gasela', 14, 'Obat lambung', NULL, 'Ranitidine 150 mg'),
(17, 'Grafachlor', 15, 'Antialergi/kortikosteroid', NULL, 'Dexamethasone 0,5 mg, Dexchlorpheniramine maleat 2 mg'),
(18, 'Grafazole', 16, 'Antibiotik/antiprotozoa', NULL, 'Metronidazole 500 mg'),
(19, 'Grafalin', 17, 'Bronkodilator/asma', NULL, 'Salbutamol 4 mg'),
(20, 'Histigo', 18, 'Obat vertigo', NULL, 'Betahistine mesilate 6 mg'),
(21, 'ISDN', 19, 'Obat jantung/antiangina', NULL, 'Isosorbide dinitrate 5 mg'),
(22, 'Hufaxol', 20, 'Mukolitik/ekspektoran', NULL, 'Ambroxol 30 mg'),
(23, 'Orphen', 21, 'Antihistamin', NULL, 'Chlorpheniramine maleat 4 mg'),
(24, 'Omegesic', 22, 'Analgesik + vitamin B', NULL, 'Metamizole sodium, Thiamin mononitrate, Pyridoxine HCl, Cyanocobalamine'),
(25, 'Omeproxil', 9, 'Antibiotik', NULL, 'Ciprofloxacin 500 mg'),
(26, 'Omedom', 23, 'Antiemetik/prokinetik', NULL, 'Domperidone 10 mg'),
(27, 'Milorin', 9, 'Antibiotik', NULL, 'Clindamisin 500 mg'),
(28, 'Lokev', 14, 'Obat lambung', NULL, 'Omeprazole 20 mg');
...
--
ALTER TABLE `create_generic_name`
  MODIFY `generic_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT untuk tabel `create_medicine_name`
--
ALTER TABLE `create_medicine_name`
  MODIFY `medicine_name_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
